...
const WorksGallery = ({ onComplete }) => {
  ...
  const works = [
    ...
    },
    {
      id: "kamal",
      title: "کمال سکون",
      subtitle: "متن به‌مثابۀ اجرای نمایشی (شعر جنبشی)",
      year: "۱۴۰۴",
      author: "محمود فتوحی رودمعجن",
      desc: "یک شعر فلسفی عرفانی، از طریق فیزیک محاسباتی به یک تجربهٔ اجرایی تبدیل شده‌است.",
